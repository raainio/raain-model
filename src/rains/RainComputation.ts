 ...
 *  not used directly
 */
export class RainComputation extends RaainNode {
    ...
    public addRadarLinks(linksToAdd: Link[] | RaainNode[]): void {
        this.addLinks(RainComputation._getRadarLinks(linksToAdd));
    }

    public replaceRainLink(linksToAdd: Link | RaainNode | any): void {
        this.addLinks([RainComputation._getRainLink(linksToAdd)]);
    }

    public addRadarMeasureLinks(linksToAdd: Link[] | any[]): void {
        this.addLinks(RainComputation._getRadarMeasureLinks(linksToAdd));
    }
