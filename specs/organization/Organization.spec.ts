...
describe('Organization', () => {
    it('should create People, Team, Event', () => {
        ...
        expect(JSON.stringify(user2.toJSON())).eq(
            '{"id":"uid1","roles":["user","test","admin"],"email":"user1@null.com","name":"user1"}'
        );
        ...
        expect(JSON.stringify(team2.toJSON())).eq(
            '{"id":"tid1","links":[],"name":"team1","description":"team...","contracts":["basic"],"contacts":[{"id":"uid1","roles":["user","test","admin"],"email":"user1@null.com","name":"user1"}]}'
        );
        ...
        expect(JSON.stringify(eventNode2.toJSON())).eq(
            '{"id":"event1","title":"EventNode looks OK.","status":0,"red":false,"description":"need help on...","created":"1970-01-01T00:00:00.123Z","modified":"1970-01-01T00:00:00.132Z"}'
        );
    });
});
