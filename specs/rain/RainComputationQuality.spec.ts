...
describe('RainComputationQuality', () => {
    ...
    it('should add rainComputation link from id/_id and toJSON returns id', () => {
        const fromId = new RainComputationQuality({
            ...base,
            rainComputation: {id: 'rid', date: new Date(), version: 'v'} as any,
        });
        const fromMongo = new RainComputationQuality({
            ...base,
            rainComputation: {_id: 'mid', date: new Date(), version: 'v'} as any,
        });
    ...
    it('should merge value fields and qualitySpeedMatrixContainer via merge', () => {
        const a = new RainComputationQuality({
            ...base,
            quality: 0.5,
            progressIngest: 60,
            progressComputing: 80,
            timeSpentInMs: 10,
        });
        const b = new RainComputationQuality({
            ...base,
            date: new Date('2020-01-02T00:00:00Z'),
            quality: 1,
            progressIngest: 40,
            progressComputing: 20,
            timeSpentInMs: 15,
        });
        // spy merge
