...
import {CartesianGaugeHistory, CartesianRainHistory, CartesianValue, PositionHistory} from '../../src';
...
describe('Quality History models', () => {
  ...
  it('PositionHistory should keep optional fields', () => {
    const h = new PositionHistory({
      id: 'p1', label: 'Pos', date: '2020-03-03' as any, x: 1, y: 2, value: 5,
      valueFromGauge: 10, valueFromRain: 12, configurationAsJSON: '{"x":1}',
    } as any);
    expect(h.id).eq('p1');
